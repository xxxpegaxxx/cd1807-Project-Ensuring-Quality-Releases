...
driver.find_element(By.CSS_SELECTOR,"input[id='search_query_top']").send_keys(search_item)
driver.find_element(By.CSS_SELECTOR,"button[class='btn btn-default button-search']").click()
...
results = driver.find_element(By.CSS_SELECTOR,"div[id='center_column'] > h1 > span.heading-counter").text
...
if '1' in results:
    ...
    print ("ERROR: We did not find 1 result successfully")